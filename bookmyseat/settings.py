...
EMAIL_HOST_USER = 'soldierboyab@gmail.com'

EMAIL_HOST_PASSWORD = 'zykjwblgnwezpcic'

DEFAULT_FROM_EMAIL = EMAIL_HOST_USER


RAZORPAY_KEY_ID = 'rzp_test_SthT8n4g0YANdw'          # from Razorpay dashboard
RAZORPAY_KEY_SECRET = 'BEzUHp245YscseZ7x2xi55Mb'  # from Razorpay dashboard


# settings.py

# Fixes YouTube Error 153 by safely sharing your site origin with Google
...
CACHES = {
    'default': {
        ...
        'LOCATION': 'redis://localhost:6379/1',  # use db 1, not 0 (celery uses 0)
...
CSRF_TRUSTED_ORIGINS = ['https://sulk-winter-catching.ngrok-free.dev']
